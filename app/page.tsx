...
const projectsData = [
  {
    ...
    icon: Database,
    color: "blue",
    images: ["/project/product-management/satu.png", "/project/product-management/dua.png", "/project/product-management/tiga.png"],
  },
  {
    id: 2,
    ...
    icon: ChartSpline,
    color: "emerald",
    images: ["/project/product-monitoring/satu.png", "/project/product-monitoring/dua.png", "/project/product-monitoring/tiga.png"],
  },
  {
    id: 3,
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-neutral-400 font-sans selection:bg-blue-500/30 selection:text-blue-200">
      ...
      <nav className="fixed w-full backdrop-blur-md bg-[#0a0a0a]/80 border-b border-neutral-800 z-50">
        <div className="max-w-5xl mx-auto px-6 py-4 flex justify-between items-center">
          <span className="font-mono font-bold text-neutral-100">&lt;Rizky_E /&gt;</span>
      ...
      <ScrollReveal delay={0.4}>
        <section id="about" className="pt-55 pb-65 px-1 max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="flex-1 w-full">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-100 mb-4 tracking-tight">Rizky Erlangga</h1>
            <h2 className="text-xl md:text-2xl text-neutral-300 mb-6 font-medium">IT Software & Development Engineer</h2>
            <p className="text-base leading-relaxed mb-8 text-neutral-400">
              A Full-Stack Developer with 4+ years of experience delivering web-based solutions in the insurance and manufacturing sectors. Passionate about building scalable applications, optimizing
              business processes, and leveraging technology to enhance user experience and generate measurable business outcomes.
            </p>
          ...
          <div className="relative w-full max-w-[280px] md:max-w-[320px] shrink-0">
            ...
            <div className="relative z-10 w-full aspect-[4/5] rounded-2xl overflow-hidden border border-neutral-800 bg-neutral-900 shadow-2xl group">
              <img src="/profile-photo.jpg" alt="Profile of Rizky Erlangga" className="w-full h-full object-cover object-center grayscale group-hover:grayscale-0 transition-all duration-500" />
            </div>
          </div>
        </section>
      </ScrollReveal>
      ...
      <section id="experience" className="py-16 px-6 max-w-7xl mx-auto overflow-hidden">
        <ScrollReveal delay={0.4}>
            ...
            <div className="relative flex flex-col md:flex-row w-full mb-16 md:mb-24">
              ...
              <div className="w-full md:w-1/2 pl-10 md:pl-0 md:pr-16 md:text-right">
                ...
                <p className="text-sm leading-relaxed mb-6 md:ml-auto">
                  As a member of the IT Software & Development team at PT Asuransi MSIG Indonesia, I am responsible for developing, maintaining, and enhancing web-based applications that support
                  business operations for one of the leading global general insurance companies. My role involves implementing new features, integrating systems, optimizing application performance,
                  and troubleshooting production issues to ensure operational efficiency and system stability.
                </p>
                <div className="flex flex-wrap md:justify-end gap-2">
                  <span className="px-2 py-1 bg-neutral-900 border border-neutral-800 rounded text-xs font-mono">Laravel</span>
                  <span className="px-2 py-1 bg-neutral-900 border border-neutral-800 rounded text-xs font-mono">Livewire</span>
                  <span className="px-2 py-1 bg-neutral-900 border border-neutral-800 rounded text-xs font-mono">Next.Js</span>
                  <span className="px-2 py-1 bg-neutral-900 border border-neutral-800 rounded text-xs font-mono">Golang</span>
                  <span className="px-2 py-1 bg-neutral-900 border border-neutral-800 rounded text-xs font-mono">Python</span>
                </div>
              </div>
            ...
            <div className="relative flex flex-col md:flex-row w-full">
              ...
              <div className="w-full md:w-1/2 pl-10 md:pl-16 text-left">
                ...
                <div className="flex flex-wrap items-center text-sm font-mono text-neutral-500 mt-1 mb-4 gap-y-2 gap-x-4">
                  <span className="text-emerald-400">PT. Sagara Xinix Solusitama</span>
                  <span className="flex items-center">
                ...
                <p className="text-sm leading-relaxed mb-6">
                  As a Web Developer at PT Sagara Xinix Solusitama, I was responsible for designing, developing, and maintaining web applications that improved operational efficiency and streamlined
                  business processes for clients in various industries. I primarily worked with PHP, Laravel, JavaScript, and MySQL while collaborating with stakeholders to gather requirements,
                  implement solutions, and provide technical support.
                </p>
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="px-2 py-1 bg-neutral-900 border border-neutral-800 rounded text-xs font-mono">Docker</span>
                </div>
              </div>
            </div>
          </ScrollReveal>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-neutral-900/50 border border-neutral-800 rounded-lg">
                ...
                <p className="text-sm text-neutral-500">MySQL, MongoDB, PostgreSQL, Linux, Nginx</p>
              </div>
            </div>
          </div>
        </ScrollReveal>
      ...
      <section id="awards" className="py-16 px-6 max-w-7xl mx-auto overflow-hidden">
        <ScrollReveal>
          <h3 className="text-xl font-bold text-neutral-100 mb-2 flex items-center">
            <Award className="mr-3 w-5 h-5 text-neutral-500" /> Awards & Recognitions
          </h3>
          <p className="text-sm text-neutral-500 mb-8 ml-8">Milestones and achievements throughout my professional career.</p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12">
            ...
            <div className="flex flex-col space-y-4 font-mono text-sm w-full md:w-auto">
              {/* Email */}
              <a href="mailto:rizkyerlanggacontact@gmail.com" className="flex items-center text-neutral-400 hover:text-blue-400 transition-colors group">
                <span className="w-24 text-neutral-600">Email</span>
                <span className="text-neutral-300 group-hover:underline decoration-neutral-600 underline-offset-4">rizkyerlanggacontact@gmail.com</span>
              </a>

              {/* Phone */}
              <a href="tel:+6289518557336" className="flex items-center text-neutral-400 hover:text-blue-400 transition-colors group">
                <span className="w-24 text-neutral-600">Phone</span>
                <span className="text-neutral-300 group-hover:underline decoration-neutral-600 underline-offset-4">+62 89518557336</span>
              </a>

              {/* LinkedIn */}
              <a href="https://linkedin.com/in/rizky-erlangga-342806198" target="_blank" rel="noreferrer" className="flex items-center text-neutral-400 hover:text-blue-400 transition-colors group">
                <span className="w-24 text-neutral-600">LinkedIn</span>
                <span className="text-neutral-300 group-hover:underline decoration-neutral-600 underline-offset-4">Rizky Erlangga</span>
              </a>

              {/* GitHub */}
              <a href="https://github.com/Rizky905" target="_blank" rel="noreferrer" className="flex items-center text-neutral-400 hover:text-blue-400 transition-colors group">
                <span className="w-24 text-neutral-600">GitHub</span>
                <span className="text-neutral-300 group-hover:underline decoration-neutral-600 underline-offset-4">github.com/Rizky905</span>
              </a>
            </div>
          </div>
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          <div className="absolute inset-0 bg-black/80 backdrop-blur-sm transition-opacity" onClick={() => setSelectedProject(null)}></div>
          ...
          <div className="relative bg-[#0f0f0f] border border-neutral-700 rounded-2xl w-full max-w-7xl max-h-[90vh] flex flex-col shadow-2xl animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
            <div className="flex items-center justify-between p-5 md:p-6 border-b border-neutral-800 bg-[#0f0f0f] z-10 shrink-0">
              <div className="flex items-center pr-4">
                ...
                <h2 className="text-xl md:text-2xl font-bold text-neutral-100 truncate">{selectedProject.title}</h2>
              </div>
              <button onClick={() => setSelectedProject(null)} className="p-2 text-neutral-400 hover:text-white hover:bg-neutral-800 rounded-full transition-colors shrink-0">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-5 md:p-8 overflow-y-auto custom-scrollbar">
              <div className="mb-8 space-y-4">
                {selectedProject.images.map((imgSrc, index) => (
                  <div key={index} className="rounded-xl overflow-hidden border border-neutral-800 bg-neutral-900 group">
                    <img src={imgSrc} alt={`${selectedProject.title} screenshot ${index + 1}`} className="w-full h-auto object-cover group-hover:scale-[1.02] transition-transform duration-700" />
                  </div>
                ))}
              </div>
              ...
              <div className="mb-8">
                ...
                <p className="text-neutral-300 leading-relaxed text-sm md:text-base">{selectedProject.fullDesc}</p>
              </div>
